...
function dart_precompiled($collectedClasses) {
  ...
  function CutsceneManager(initialized, playing, scene, friendlyCounter, startCamera, game, cutscenes) {
    this.initialized = initialized;
    this.playing = playing;
    this.scene = scene;
    this.friendlyCounter = friendlyCounter;
  ...
  function NPCManager(game, drag, allyPool) {
    this.game = game;
    this.drag = drag;
  ...
  function Enemy(ally, facingRight, grounded, dead, deadFrame, originalHeight, originalWidth, game, position, acceleration, dyingFrames, idleFrames, runningFrames, view) {
    this.ally = ally;
  ...
  function World(game, originalHeight, originalWidth, map, foreground, myCanvas, CanvasCtx) {
    this.game = game;
    this.originalHeight = originalHeight;
    this.originalWidth = originalWidth;
    this.map = map;
  ...
  function main_closure(box_0, progressBar_1) {
    this.box_0 = box_0;
  ...
  function main_closure0(progressBar_2) {
